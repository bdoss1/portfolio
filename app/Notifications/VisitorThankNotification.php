...
class VisitorThankNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->greeting(__('notifications.hello') . ', ' . empty($this->form->user->name) ? $this->form->name : $this->form->user->name)
            ...
            ->subject(__('notifications.subjects.thank_for_your_message') . ', ' . empty($this->form->user->name) ? $this->form->name : $this->form->user->name);
    }
